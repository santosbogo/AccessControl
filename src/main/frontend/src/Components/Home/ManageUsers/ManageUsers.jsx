...
const ManageUsers = () => {
    ...
    const fetchAllUsers = async () => {
        try {
            const response = await axios.get(`${process.env.publicIP}/users/findAll`);
    ...
    const handleDeactivateUser = async (userId) => {
        ...
        try {
            await axios.post(`${process.env.publicIP}/user/deactivate/${userId}`);
    ...
    const handleActivateUser = async (userId) => {
        ...
        try {
            await axios.post(`${process.env.publicIP}/user/activate/${userId}`);
